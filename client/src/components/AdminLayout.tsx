...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      <aside className="border-b border-[color:var(--line)] bg-[color:rgba(255,249,238,0.92)] p-4 lg:w-72 lg:border-b-0 lg:border-r lg:p-6">
        <div className="mb-5">
      ...
      <main id="main-scroll" className="flex-1 overflow-auto p-4 sm:p-6">
